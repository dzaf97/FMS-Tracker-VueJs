    ...
    animation: {
        ...
        onProgress: function (chart) {
            if (chart.chart.config.options.elements.center) {
                ...
                //Draw text in center
                ctx.fillText("Assigned", centerX, centerY - 30);
                ctx.fillText("VS", centerX, centerY - 5);
                ctx.fillText("Unassigned", centerX, centerY + 15);
                ctx.fillText("Truck", centerX, centerY + 35);
            }
        },
    },
